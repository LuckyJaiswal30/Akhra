...
export default async function TeamPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const isAdmin = actor.role === 'university_admin';
  ...
  return (
    <div className="space-y-8">
      <header>
        <h1 className="text-2xl font-bold">{t('tabTeam')}</h1>
      </header>
            ...
            <>
              ...
              <InviteForm
                roles={[
                  ...
                  { value: 'faculty', label: roleLabel('faculty') },
                  { value: 'university_admin', label: roleLabel('university_admin') },
                ]}
                labels={labels}
              />
